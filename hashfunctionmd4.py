...
# The MD4 transformation functions for rounds 1, 2, and 3
def FF(a, b, c, d, x, s):
...
# Function to convert the hash to a readable hex string
def md4_hexdigest(message):
    return md4(message).hex()

# Example usage
message = b"Hello, world!"
print(md4_hexdigest(message))